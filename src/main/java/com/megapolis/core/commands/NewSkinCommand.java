...
public class NewSkinCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) { player.sendMessage("§eИспользование: /newskin <название_скина>"); return true; }
        MegapolisPlugin.getInstance().getModuleManager().getSkinManager().createSkinItemFromCurrent(player, args[0]);
        return true;
    }
}
